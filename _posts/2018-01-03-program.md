...
: See [the slides](resources/wapi18_eilertsen_evol.pdf) and [the code](http://github.com/nuthatchery/java-analysis).
...
: See <a name="murphy-hill-usability"></a>[the slides](resources/wapi18_murphy-hill_api_usability.pdf).
